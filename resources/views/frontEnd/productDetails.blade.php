			...
			<div class="span6">
				...
				<hr class="soft"/>
				  ...
				  <div class="control-group">
					...
					<div class="controls">
						<form method="get" action="{{route('cartStore')}}">
					...
					@if(Auth::user())
					  ...
					  @else
          <button  class="btn btn-large btn-primary pull-right"><a style="    color: #fff;
    text-decoration: none;" href="{{route('userLogout')}}"> Add to cart <i class=" icon-shopping-cart"></i></a></button>
					  @endif
					  </form>
					</div>
				  </div>
				...
				<hr class="soft"/>
				<h4>{{$product->ProductDetail->total_item ?? ''}} items in stock</h4>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="{{asset('uploads/'.$related_product->image)}}" style="width: 200px;height: 200px;" alt=""/></a>
						<div class="caption">
