...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<a href="register.html"><img style="width:100%" src="{{asset('themes/images/carousel/picture1.JPG')}}" alt="special offers"/></a>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="register.html"><img style="width:100%" src="{{asset('themes/images/carousel/picture2.JPG')}}" alt=""/></a>
				<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
	...
	@php $i=1; @endphp
			  <ul class="thumbnails">
				...
				<li class="span3">
				  <div class="thumbnail">
				  <i class="tag"></i>
					<a href="{{route('productDetails',$value->id)}}"><img style="width:200px;height:200px" src="{{asset('uploads/'.$value->image)}}" alt=""></a>
					<div class="caption">
					  <h5>{{$value->name}}</h5>
					  <h4><a class="btn" href="{{route('productDetails',$value->id)}}">VIEW</a> <span class="pull-right">RS {{$value->price}}</span></h4>
					</div>
				  </div>
				</li>
				@endforeach
