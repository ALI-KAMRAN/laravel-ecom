        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Products <small>Admin edit Products</small></h2>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" action="{{route('productsUpdate',$product->id)}}" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
                     @csrf
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                       <select name="category_id" class="form-control col-md- 12 col-xs-12" required="">
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                      <input type="text" name="name" value="{{$product->name}}" class="form-control col-md- 12 col-xs-12" required="">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                      <input type="text" name="price" value="{{$product->price}}" class="form-control col-md- 12 col-xs-12" required="">
                      </div>
                    </div>
