          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" action="{{route('productsStore')}}" method="post" class="form-horizontal form-label-left" enctype='multipart/form-data'>
                     @csrf
                   ...
                   <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                      <input type="text" name="name" class="form-control col-md- 12 col-xs-12" required="">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                      <input type="text" name="price" class="form-control col-md- 12 col-xs-12" required="">
                      </div>
                    </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                      <input type="file" name="image" class="form-control col-md- 12 col-xs-12" required="">
                      </div>
                    </div>
